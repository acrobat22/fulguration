...
use FulgurationBundle\Entity\Categorie;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('FulgurationBundle:Categorie')->findAll();
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('FulgurationBundle\Form\CategorieType', $categorie);
